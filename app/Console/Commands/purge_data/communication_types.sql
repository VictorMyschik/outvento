...
insert into public.communication_types (id, code, name_ru, name_en, name_pl, image_path) values (6, 'viber',  'Viber', 'Viber', 'Viber', null);
insert into public.communication_types (id, code, name_ru, name_en, name_pl, image_path) values (7, 'link',  'Ссылка', 'Link', 'Link', null);
insert into public.communication_types (id, code, name_ru, name_en, name_pl, image_path) values (8, 'geocoordinates',  'Геокоординаты', 'Geo coordinates', 'Współrzędne geograficzne', null);
insert into public.communication_types (id, code, name_ru, name_en, name_pl, image_path) values (9, 'other',  'Другое', 'Other', 'Inne', null);
