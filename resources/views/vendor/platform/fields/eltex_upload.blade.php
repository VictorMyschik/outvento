                ...
                <div class="modal-dialog modal-fullscreen-md-down">
                    <div class="modal-content border">
                        <div class="modal-header">
                            <h5 class="modal-title text-black fw-light">
                                {{__('File Information')}}
                        ...
                        <div class="modal-body p-3">
                            ...
                            <div class="form-group" style="display: none">
                                ...
                                <input type="text" class="form-control" data-upload-target="original" maxlength="255">
                            </div>
                            <div class="form-group">
                                <label>Наименование картинки</label>
                                <input type="text" class="form-control"
                                       data-upload-target="description" maxlength="255">
                            </div>
                            <div class="form-group">
                ...
                <template id="dropzone-{{$id}}-media">
                    <div class="col-4 col-sm-3 my-3 position-relative media-item">
                        <div data-action="click->upload#addFile" data-key="{index}">
                            <img src="{element.url}" class="rounded mw-100"
                                 style="height: 50px;width: 100%;object-fit: cover;">
                            <p class="text-ellipsis small text-muted mt-1 mb-0" title="{element.original_name}">
                                {element.original_name}111111</p>
                        </div>
                    </div>
                </template>
            @endif
